package com.mitesh.cloud.techlearn.docker.HelloworldRestApiClient.configuration;
...
public class SwaggerConfiguration {
	...
	public Docket apiV1() {
		return new Docket(DocumentationType.SWAGGER_2)
				.groupName("V1")
				.select()
                .apis(RequestHandlerSelectors.basePackage("com.mitesh.cloud.techlearn.docker.HelloworldRestApiClient.controller"))
